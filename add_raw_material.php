    ...
    <div class="wrapper">
        <div class="title">
         ...
         <div class="field">
            ...
            <!-- <div class="field">
                <tr><input type="text" name="total price" required>
                    <label for="total price">Total price of raw material</label>
                </tr>
            </div> -->
            <!-- <div class="field">
                <tr><a href="add_raw_matireal.php"><button class="btn btn-primary active" onclick="fun1()" name="button1">Add  another raw matireal</button></a>
            </div>
            <div class="field">
                <tr><a href="manage.php"><button class="btn btn-warning active" onclick="fun2()" name="button2">Done</button></a>
                </tr>
            </div> -->
            <div class="field">
